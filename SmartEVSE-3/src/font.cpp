...
const unsigned char font[0x7F][5] = {
    ...
    {0x3C, 0x7E, 0x7E, 0x7E, 0x3C}, // 0x04 Mode icon: STOPPED (filled square)
    {0x7E, 0x7E, 0x00, 0x7E, 0x7E}, // 0x05 Mode icon: PAUSED (pause bars)
    {0x48, 0x2C, 0x16, 0x05, 0x04}, // 0x06 Mode icon: NORMAL (lightning bolt)
    {0x2A, 0x1C, 0x7F, 0x1C, 0x2A}, // 0x07 Unused (was Mode icon: SOLAR)
    {0x1C, 0x3E, 0x08, 0x3E, 0x1C}, // 0x08 Mode icon: SMART (bidirectional arrow)
